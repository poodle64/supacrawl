...
This guide explains how to create and manage site configurations for supacrawl.
...
- `docs/30-architecture/site-configuration-supacrawl.md` - Site configuration system overview
