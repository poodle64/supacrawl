...
- `.cursor/rules/70-error-handling-web-scraper.mdc` - Configuration error handling
- `docs/40-usage/creating-site-configs-web-scraper.md` - Configuration creation guide
